...
THINCLIENT_DEFAULT_PACKAGES = 'toweros-thinclient toweros-thinclient-builds alpine-base linux-lts xtables-addons-lts zfs-lts syslinux intel-media-driver libva-intel-driver linux-firmware linux-firmware-none'.split(" ")
